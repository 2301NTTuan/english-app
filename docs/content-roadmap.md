...
5. Add multiple unambiguous templates per learning item and balance recall, production, listening, and context outside the completed Placement bank.
6. Reassess source-backed and editorial CEFR/frequency metadata against real learner evidence with consent/privacy review.
7. Add content deprecation redirects so published IDs never silently orphan history.
