...
export default function Dashboard() {
  ...
  return <>
    ...
    <div className="page-grid">
      ...
      <section className="card p-5 sm:p-6 lg:col-span-7"><SectionTitle title="Knowledge health" subtitle="Mastery across active skills" href="/progress"/><div className="space-y-4">{[["Vocabulary recognition", dimensions.recognition, "#17795b"], ["Vocabulary recall", dimensions.recall, "#d7922c"], ["Grammar", dimensions.grammar, "#5278bb"], ["Context use", dimensions.context, "#b15c7e"]].map(([label, value, color]) => <div key={String(label)}><div className="mb-1.5 flex justify-between text-sm"><b>{label}</b><span className="muted">{value}%</span></div><ProgressBar value={Number(value)} color={String(color)}/></div>)}</div></section>
